    ...
    for testnumber in range(num_iterations_to_run):
        ...
        class MyProblemParallel(Problem):
            ...
            def __init__(self):
                ...
                super().__init__(n_var=8, n_obj=1, n_ieq_constr=5, xl=[0,0,0,0,0,0,0,0], xu=[7,5,4,4,5,4,5,6], vtype=int,elementwise_evaluation=True)
